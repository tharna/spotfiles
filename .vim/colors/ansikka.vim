" ansikka.vim
" Author:      Janne Koponen <tharnakus@gmail.com>
" Last Change: 08 Dec 2011
" License:     as-is
" Based mainly on ansi_blows with some elements from af
...
exe 'hi LineNr       ctermfg=lightGrey guifg=' . s:yellow
exe 'hi Question     guifg=' . s:boldGreen . ' gui=none'
exe 'hi StatusLine   cterm=none ctermfg=8 ctermbg=8 gui=reverse'
exe 'hi StatusLineNC cterm=reverse gui=reverse'
exe 'hi VertSplit    cterm=none ctermfg=0 ctermbg=0 gui=reverse'
...
exe 'hi TabLine      cterm=none ctermbg=8 guifg=fg guibg=bg gui=underline'
exe 'hi TabLineSel   cterm=bold guifg=' . s:boldWhite
exe 'hi TabLineFill  cterm=none ctermbg=8 gui=reverse'
...
exe 'hi MatchParen   cterm=bold guifg=' . s:boldRed . ' guibg=' . s:cyan
" exe 'hi Comment      guifg=' . s:boldGrey
...
hi phpSpecial ctermfg=Blue
hi phpFunctions ctermfg=39

let colors_name = "ansikka"
